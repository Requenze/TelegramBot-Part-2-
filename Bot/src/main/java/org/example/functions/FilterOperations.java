...
public class FilterOperations {
    @AppBotCommand(name = "grayScale", description = "Оттенки серого")
    ...
    @AppBotCommand(name = "OnlyRed", description = "Только красный")
    public static float[] onlyRed(float[] rgb) {
        rgb[1] = 0;
        rgb[2] = 0;
        return rgb;
    }
    @AppBotCommand(name = "onlyGreen", description = "Только зелёный")
    public static float[] onlyGreen(float[] rgb) {
        rgb[0] = 0;
        rgb[2] = 0;
        return rgb;
    }
    @AppBotCommand(name = "onlyBlue", description = "Только синий")
